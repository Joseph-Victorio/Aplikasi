<template>
   <q-page class="romance bg-light main-page">
      <q-header reveal :reveal-offset="10" class="bg-white box-shadow"
         ...
         <q-toolbar class="q-py-sm">
            ...
            <div class="col q-ml-sm row items-center">
               <div class="col">
                  <q-input borderless ref="input" color="grey-4" dense class="input-search text-xs bg-grey-1"
                     v-model="search" @keyup.enter="searchNow" placeholder="cari produk...">
      ...
      <template v-if="!loading">
         ...
         <ProductSectionObserver v-if="is_category_mode" />
         <ProductContainer v-else />
...
export default {
   ...
   computed: {
      ...
      is_category_mode() {
         if (this.config && this.config.home_product_view == 'by_category') {
            return true
         }
         return false
      },
