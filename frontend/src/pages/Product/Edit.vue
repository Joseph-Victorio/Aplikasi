              ...
              <div class="row q-gutter-md">
                ...
                <div class="box-image relative cursor-pointer"
                  ...
                  <div class="absolute-top-right">
                    <q-btn dense @click.prevent="removeImage(image, index)" size="10px" unelevated icon="close"
                      color="red" padding="1px" />
                  </div>
                </div>
              </div>
              <div class="text-xs text-grey q-mt-md" v-if="imagePreview.length">Untuk memilih featured image klik pada
                gambar</div>
            </div>
          </div>
        </q-card-section>
        ...
        <q-card-section v-if="!form.simple_product" class="">
          <div id="variants">
            <div class="row items-center q-gutter-sm q-py-md q-mb-md">
              ...
              <q-btn v-if="canAddVarian" outline icon="add" no-caps label="Tambah Varian" @click="varianModal = true"
                color="primary" unelevated size="12px"></q-btn>
            </div>
            <div v-if="form.varians.length">
              <div v-if="form.varians[0].has_subvarian">

                <q-card v-for="(varian, varIndex) in form.varians" :key="varIndex" class="q-mb-lg bg-grey-1" flat
                  bordered>
                  <q-card-section class="q-px-sm">
                    <div class="row items-center justify-between q-mb-sm q-px-sm">
                      ...
                      <q-btn-dropdown flat dropdown-icon="more_vert" unelevated auto-close fab-mini no-icon-animation
                        padding="xs">
                      ...
                      <q-item class="bg-white q-mb-sm box-shadow"
                        ...
                        <q-item-section>
                          <q-item-label class="q-mb-xs">
                            <q-input class="multi-varian" :class="'main-var-' + varIndex" stack-label required
                              v-model="form.varians[varIndex].subvarian[subIndex].value"
                        ...
                        <q-item-section>
                          <q-item-label class="q-mb-xs">
                            <money-formatter stack-label required
                              v-model="form.varians[varIndex].subvarian[subIndex].weight" label="Berat" suffix="Gram" />
                          </q-item-label>
                          <q-item-label>
                            <money-formatter stack-label required
                ...
                <q-card-section>
                  ...
                  <q-list>
                    <q-item class="bg-white q-mb-sm box-shadow" v-for="(varian, vIndex) in form.varians" :key="vIndex">
                      ...
                      <q-item-section>
                        <q-item-label class="q-mb-xs">
                          <q-input class="single-varian" :class="'input-var-' + vIndex" stack-label square required
                            v-model="form.varians[vIndex].value" :label="form.varians[vIndex].label"></q-input>
                        </q-item-label>
                        <q-item-label>
                          <money-formatter stack-label required v-model="form.varians[vIndex].price" prefix="Rp"
                            label="Harga Jual" />
                        </q-item-label>
                      </q-item-section>
                      <q-item-section>
                        <q-item-label class="q-mb-xs">
                          <money-formatter stack-label required v-model="form.varians[vIndex].weight" label="Berat"
                            suffix="Gram" />
                        </q-item-label>
                        <q-item-label>
                      ...
                      <q-item-section side>
                        ...
                        <q-btn unelevated padding="2px" icon="eva-copy" size="13px" color="blue" class="q-mt-sm"
                          @click="duplicateVarian(varian, vIndex, `input-var-`)"></q-btn>
                      </q-item-section>
...
export default {
  ...
  methods: {
    ...
    setData() {
      ...
      this.form.product_url = this.product.product_url ?? ''
