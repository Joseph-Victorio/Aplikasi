   ...
   <q-page class="flex flex-center relative">
      ...
      <div style="max-width: 420px;width:100%;" class="q-pa-sm">
         <div class="flex justify-center">
            <img v-if="shop && shop.logo_path" :src="shop.logo"
               style="width:auto;height:75px;object-fit:contain;max-width:150px;" />
            <img v-else src="/icon/icon-192x192.png"
               style="width:auto;height:75px;object-fit:contain;max-width:150px;" />
         </div>
         ...
         <q-card flat class="q-pt-sm" style="background:rgb(255 255 255 / 71%);">
            <q-card-section>
               <form @submit.prevent="submit" class="q-gutter-y-sm q-pa-md">
                  ...
                  <q-input v-model="form.password" label="Password Anda *" color="grey-6"
                  ...
                  <div class="column">
                     <q-btn :loading="isLoading" type="submit" color="primary" padding="sm lg">Login</q-btn>
          ...
          Belum punya akun <q-btn no-caps color="primary" padding="xs" flat :disable="isLoading" label="Daftar Disini" :to="{ name: 'Register'}"></q-btn>
               ...
               <div class="text-center q-mt-sm">
                  <q-btn no-caps color="primary" padding="xs" flat :disable="isLoading" label="Lupa password?"
