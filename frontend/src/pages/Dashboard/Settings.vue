   ...
   <q-page class="q-pb-xl">
      <q-header :class="getHeaderColorBrand">
         <q-toolbar>
            ...
            <q-btn :to="{ name: 'Home', query: { load: 'true' } }" flat icon-right="eva-arrow-forward"
               label="Lihat Toko" no-caps />
         </q-toolbar>
      </q-header>
   ...
   data() {
      return {
         ...
         menus: [
            ...
            { label: 'Block Banner', caption: 'Kelola banner, partner dan featured', path: 'AdminBlockIndex', icon: 'space_dashboard', color: 'amber-7' },
