<template>
  ...
  <q-list>
    <q-item>
      ...
      <q-item-section side>
        <q-toggle v-model="form.is_whatsapp_checkout" :label="form.is_whatsapp_checkout? 'ON' : 'OFF'" left-label color="teal"></q-toggle>
      </q-item-section>
    </q-item>
    <q-item>
      <q-item-section>
      ...
      <q-item-section side>
        <q-toggle v-model="form.is_guest_checkout" :label="form.is_guest_checkout? 'ON' : 'OFF'" left-label color="teal"></q-toggle>
      </q-item-section>
    </q-item>
  </q-list>
