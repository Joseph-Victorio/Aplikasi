<template>
   <q-card flat class="q-pa-sm">
      <q-card-section>
         ...
         <q-list>
            ...
            <q-item class="q-px-xs">
               ...
               <q-item-section side>
                  <div class="cursor-pointer img-thumbnail"
                     :style="`width:110px;height:30px;background-color:${form.theme_color}`">
            ...
            <q-item class="q-px-xs">
               ...
               <q-item-section side>
                  <div class="cursor-pointer img-thumbnail"
                     :style="`width:110px;height:30px;background-color:${form.primary_color}`">
                     <q-popup-proxy transition-show="scale" transition-hide="scale">
            ...
            <q-item class="q-px-xs">
               ...
               <q-item-section side>
                  <div class="cursor-pointer img-thumbnail"
                     :style="`width:110px;height:30px;background-color:${form.secondary_color}`">
                     <q-popup-proxy transition-show="scale" transition-hide="scale">
            ...
            <q-item class="q-px-xs">
               ...
               <q-item-section side>
                  <div class="cursor-pointer img-thumbnail"
                     :style="`width:110px;height:30px;background-color:${form.accent_color}`">
                     <q-popup-proxy transition-show="scale" transition-hide="scale">
            ...
            <q-item class="q-mt-md q-px-xs">
               ...
               <q-item-section side top>
                  <q-toggle v-model="form.review_auto_approved"
            ...
            <q-item class="q-mt-md q-px-xs">
               ...
               <q-item-section side top>
                  <q-toggle v-model="form.is_notifypro" :label="form.is_notifypro ? 'Active' : 'Disabled'" left-label
                     color="teal"></q-toggle>
               </q-item-section>
            </q-item>
            <q-item v-if="form.is_notifypro" class="q-px-none">
               <q-item-section>
                  <q-input filled label="Jeda Waktu Tayang" mask="###"
                     :hint="'Popup akan tayang setiap ' + form.notifypro_interval + ' Detik'"
                     v-model="form.notifypro_interval"></q-input>
               </q-item-section>
               <q-item-section>
                  <q-input filled label="Durasi Penayangan" mask="###"
                     :hint="'Popup akan tayang selama ' + form.notifypro_timeout + ' Detik'"
                  ...
                  <q-item-section>
                     <q-item-label>
                        <q-select filled v-model="form.home_product_sort" label="Urutan Produk"
                           :options="[...sorts, { value: 'RANDOM', label: 'Random' }]" emit-value
                           map-options></q-select>
                     </q-item-label>
                  </q-item-section>
                  <q-item-section>
                     <q-item-label>
                        <q-select filled v-model="form.home_view_mode" label="Tampilan Mode"
                           :options="[{ value: 'grid', label: 'Grid Mode' }, { value: 'list', label: 'List Mode' }]"
            ...
            <div class="q-mt-md">
               ...
               <q-item class="q-px-none q-mt-xs">
                  ...
                  <q-item-section>
                     <q-item-label>
                        <q-select filled v-model="form.catalog_product_sort" label="Urutan Produk" :options="sorts"
                           emit-value map-options></q-select>
                     </q-item-label>
                  </q-item-section>
                  <q-item-section>
                     <q-item-label>
                        <q-select filled v-model="form.product_view_mode" label="Tampilan Mode"
                           :options="[{ value: 'grid', label: 'Grid Mode' }, { value: 'list', label: 'List Mode' }]"
                           emit-value map-options></q-select>
                     </q-item-label>
                  </q-item-section>
      ...
      <q-card-section>
         <q-btn class="full-width" label="Simpan Pengaturan" color="primary" @click="saveTampilan"></q-btn>
      </q-card-section>
   </q-card>
</template>
