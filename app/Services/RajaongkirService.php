...
class RajaongkirService
{
   ...
   {
      $config = Config::select('rajaongkir_type','rajaongkir_apikey',)->first();

      $this->api_key = $config->rajaongkir_apikey;
      ...
      $this->couriers = $couriers[$config->rajaongkir_type];
   }
   ...
   {
      return $this->httpPost('waybill', $payload);
   }
